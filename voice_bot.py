...
openai.api_key = "INSERT OPENAI API TOKEN"
TELEGRAM_API_TOKEN = "INSERT TELEGRAM BOT API TOKEN"

messages = [{"role": "system", "content": "You are a helpful telegram bot who is always concise and polite in its answers."}]
